    ...
    <>
        ...
        <Parallax pages={5}>
            <Hero offset={0}>
                ...
                <Subtitle>
                    I'm creating awesome web experiences for the next generation
            ...
            <Projects offset={1}>
                ...
                <ProjectsWrapper>
                    ...
                    >
                        ...
                        <br /> React Hooks | PosgreSQL | NodeJS | SCSS | Nodemailer | Socket.IO | Express | Axios | Massive | Bcrypt
                    </ProjectCard>
                </ProjectsWrapper>
            ...
            <Contact offset={4}>
                <Inner>
                    ...
                    <ContactText>
                        Say <a href="mailto:alexlangford1@live.com">Hi</a> or
                ...
                <Footer>
                    ...
                    <a href="https://github.com/alexlangford1/">
                        Github Repository
                    </a>
                    .
                </Footer>
